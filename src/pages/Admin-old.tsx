  ...
  const renderStatsTab = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Progreso de Lectura</h3>
          <div className="space-y-3">
            {userProgress.slice(0, 5).map((progress, index) => (
              <div key={index} className="flex items-center justify-between">
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">{progress.profiles?.full_name || 'Usuario'}</p>
                  <p className="text-xs text-gray-500">{progress.ebooks?.title}</p>
                </div>
